...
var getWeather = exports.getWeather = function getWeather(longitude, latitude, location, callback) {
  ...
  var url = 'https://api.darksky.net/forecast/aa0c94b5fe3d0fa4e730bd4660c72e93/' + longitude + ',' + latitude;
  ...
  (0, _request2.default)({ url: url, json: true }, function (error, response, _ref2) {
    ...
    if (error) {
      ...
      callback(undefined, { forcast: daily.summary + ' It is currently ' + currently.temperature + ' degrees out with a ' + currently.precipProbability + '% chance of rain', location: location, currently: currently });
    }
  });
};