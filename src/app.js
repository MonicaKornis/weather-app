  ...
  if(!req.query.address) {
    ...
    let sendData = (err, data) => {
      if(err) {
        ...
        console.log(data);
        res.send({ title: 'Weather', forcast: data.forcast, address: req.query.address, location: data, temperatureMin: data.temperatureMin, temperatureMax: data.temperatureMax});
      }
    };
